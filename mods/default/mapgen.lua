...
--
-- Register ores
-- This is modified to increase amounts and size and reduce scarcity
--
...
function default.register_mgv6_ores()
	...
	-- And this means we skip all this down to "Scatter Ores"
	...
	-- Scatter ores
	-- Modified Scarcity, Number of Ores and Size
	...
	minetest.register_ore({
		...
		ore            = "default:stone_with_coal",
		wherein        = "default:stone",
		clust_scarcity = 19 * 19 * 19, -- 24*24*24
		clust_num_ores = 20, -- 27
		clust_size     = 8, -- 6
		y_max          = 0,
		y_min          = -31000,
	})
	...
	minetest.register_ore({
		...
		wherein        = "default:stone",
		clust_scarcity = 8 * 8 * 8, -- 9*9*9
		clust_num_ores = 13, -- 12
		clust_size     = 6, -- 3
		y_max          = 31000,
		y_min          = 1025,
	})
	...
	minetest.register_ore({
		...
		ore            = "default:stone_with_iron",
		wherein        = "default:stone",
		clust_scarcity = 20 * 20 * 20, -- 24*24*24
		clust_num_ores = 20, -- 27
		clust_size     = 8, -- 6
		y_max          = -64,
		y_min          = -31000,
	...
	minetest.register_ore({
		...
		ore            = "default:stone_with_copper",
		wherein        = "default:stone",
		clust_scarcity = 10 * 10 * 10, -- 12*12*12
		clust_num_ores = 6, -- 4
		clust_size     = 6, -- 3
		y_max          = -16,
		y_min          = -63,
	...
	minetest.register_ore({
		...
		ore            = "default:stone_with_gold",
		wherein        = "default:stone",
		clust_scarcity = 14 * 14 * 14, -- 15*15*15
		clust_num_ores = 4, -- 3
		clust_size     = 6, -- 2
		y_max          = -64,
		y_min          = -255,
	...
	minetest.register_ore({
		...
		ore            = "default:stone_with_mese",
		wherein        = "default:stone",
		clust_scarcity = 16 * 16 * 16, -- 18*18*18
		clust_num_ores = 4, -- 3
		clust_size     = 6, -- 2
		y_max          = -64,
		y_min          = -255,
	...
	minetest.register_ore({
		...
		ore            = "default:stone_with_diamond",
		wherein        = "default:stone",
		clust_scarcity = 16 * 16 * 16, -- 17*17*17
		clust_num_ores = 7, -- 4
		clust_size     = 6, -- 3
		y_max          = -128,
		y_min          = -255,
	...
	minetest.register_ore({
		...
		ore            = "default:mese",
		wherein        = "default:stone",
		clust_scarcity = 30 * 30 * 30, -- 36*36*36
		clust_num_ores = 5, -- 3
		clust_size     = 6, -- 2
		y_max          = 31000,
		y_min          = 1025,
	...
	minetest.register_ore({
		...
		ore            = "default:mese",
		wherein        = "default:stone",
		clust_scarcity = 28 * 28 * 28, -- 36*36*36
		clust_num_ores = 6, -- 3
		clust_size     = 6, -- 2
		y_max          = -1024,
		y_min          = -31000,
